...
import com.ttv.creditdemo.camera.CameraSource
import com.ttv.creditdemo.camera.CameraSourcePreview
...
import com.ttv.creditdemo.objectdetection.MultiObjectProcessor
import com.ttv.creditdemo.objectdetection.ProminentObjectProcessor
import com.ttv.creditdemo.productsearch.BottomSheetScrimView
import com.ttv.creditdemo.productsearch.Product
import com.ttv.creditdemo.productsearch.ProductAdapter
import com.ttv.creditdemo.settings.PreferenceUtils
import com.ttv.creditdemo.settings.SettingsActivity
        ...
        workflowModel = ViewModelProviders.of(this).get(WorkflowModel::class.java).apply {
            ...
            objectToSearch.observe(this@CustomModelObjectDetectionActivity, Observer { detectObject ->
                val productList: List<Product> = detectObject.labels.map { label ->
                    ...
                    Product("" /* imageUrl */, strs[0], "" /* subtitle */)
                }
